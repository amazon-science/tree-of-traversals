...
'EXPAND' - Search for edges of entities in the knowledge graph using an external API. This is a useful function for getting to the correct answer when there is not enough info in the knowledge graph (KG).
...
SELECT ENTITIES:
You have selected the following entities to expand:"""
